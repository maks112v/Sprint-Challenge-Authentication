...
To store a user against a uniqe id to make sure the user is authenteicated

1. What does bcrypt do to help us store passwords in a secure manner.

It does a one way encryption which makes it impossible for anyone to decrypt the password(except with guessing)

1. What does bcrypt do to slow down attackers?

It encryptes that password a lot of times to make sure it is very unqie
